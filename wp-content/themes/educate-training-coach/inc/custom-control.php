...
if( class_exists( 'WP_Customize_Control' ) ) {
	class Educate_Training_Coach_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'educate-training-coach-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/js/custom-controls.js', array( 'jquery' ) );

			wp_enqueue_style( 'educate-training-coach-control-switch', trailingslashit( get_template_directory_uri() ) . 'assets/css/custom-controls.css', '', time() );
